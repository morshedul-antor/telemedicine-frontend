...
export default function Update({ setIsOpen, index, curricular }) {
    const [title, setTitle] = useState(curricular.title)
    ...
    const handleUpdate = async (e) => {
        ...
        let response = await fetch(`${apiV1}/doctors/others-activity/${curricular.id}`, {
            method: 'PATCH',
            headers: {
